  ...
  return (
    <>
      <div className={styles.about1}>
        <h1 className={styles.abcontent}>About</h1>
        <p>
        ...
        epic tale of challenges across diverse domains. Decrypt the final challenge, demonstrate your mastery across domains
