    ...
    <Navbar/>
      ...
      <div className={styles.container}>
        <div className={styles['login-container']}>
            ...
            <h1>
                <span className={styles.highlight}>CODEQUEST CHRONICLES CONTEST</span>
            </h1>
            ...
            <form>
                ...
                <br />
                <input type="text" placeholder="Team Leader Name" value={teamLeaderName} onChange={(e) => setTeamLeaderName(e.target.value)} required />
                <br />
                <input type="text" placeholder="Team Leader ID" value={teamLeaderID} onChange={(e) => setTeamLeaderID(e.target.value)} required />
                <br />
                <button type="button" onClick={handleButtonClick}>ENTER THE CONTEST</button>
            </form>
        </div>
    </div>
    </>
